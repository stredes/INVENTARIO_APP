...
export default function SupplierQuickForm() {
  ...
  const onSubmit = async (e: any) => {
    ...
    try { await apiPost('/suppliers', form); setOk('Proveedor creado'); setForm({ razon_social: '', rut: '', contacto: '', telefono: '', email: '', direccion: '' }); }
